...
def parse_args():
    ...
    parser.add_argument("--width", type=float, default=5e-3, help="波宽，单位秒")

    parser.add_argument(
        "--results_dir", type=str, default="waveform_results", help="结果保存目录"
    )
...
def main():
    ...
    if args.mode == "comprehensive":
        ...
        print(f"[1:]比较波宽为 {args.width*1e3:.1f}ms 的波形...")
